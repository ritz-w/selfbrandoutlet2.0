        ...
        return (
            <div>
                <div className="checkout-header">
                    <h1>Your Payment</h1>                        
                    <h3>Your total is ${this.props.totalPrice}. Since this is a demo, you should not add your real credit card details. To try out the payment functionality, Please enter these payment details below, or return to <span className="link" onClick={this.props.backToCart}>your cart</span>.</h3>                        
